...
const definitions:GameDefinition[]=[
  ...
  {id:"CARTAS_CONTRA_HUMANIDADE",title:"Cartas contra a humanidade",summary:"Complete cartas pretas com as respostas brancas mais absurdas.",instructions:"O juiz lê a carta preta. Os demais escolhem cartas brancas em segredo; o juiz escolhe uma combinação anônima e o vencedor vira o próximo juiz.",createEngine:()=>new CartasContraHumanidadeEngine(humanity.black,humanity.white)}
];
