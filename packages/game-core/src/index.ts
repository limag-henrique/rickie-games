...
export type SessionPhase = "LOBBY" | "CONFIGURING" | "ROUND_PREPARING" | "ROUND_INTRO" | "INPUT_OPEN" | "INPUT_LOCKED" | "HOST_REVIEW" | "REVEALING" | "SCORING" | "ROUND_RESULTS" | "PAUSED" | "FINISHED" | "CANCELLED";
