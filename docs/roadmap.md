...
| 5 | Palpite escalonado + desafio | planejada |
| 6 | Administração, importação, direitos, auditoria e ativação de packs | planejada |
| 7 | Investigação isolada de música e áudio | bloqueada até requisitos e direitos confirmados |

**TO BE VALIDATED:** produto de conteúdo, regras de pontuação por jogo, política
de retenção, regiões habilitadas, capacidade alvo e credenciais de provedores.
